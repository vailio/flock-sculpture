...
function setup() {
  slider1 = createSlider(-100, 300, 15);
  slider1.position(100, 140);
  slider2 = createSlider(-100, 200, 10);
  slider2.position(100, 160);
...
//   background(bg);
  ...
  textSize(14);
  textFont("Helvetica")
  text(s2, 100, 205, 300, 700); // Text wraps within text box
}
...
Boid.prototype.flock = function(boids) {
  ...
  sep.mult(slider1.value()/10);
  ali.mult(slider2.value()/10);
  coh.mult(slider3.value()/10);
